...
## Cross-cutting — productscope-beslissingen (overlijdensdekking & omzetverzekering)

Twee verzekeringen die bewust **geen eigen pagina** krijgen. Beslist na onderzoek +
concurrentie-check (2026-06-23). Graag bevestigen.

| Code | Beslissing | Keuzemogelijkheden | Onze motivatie | Status |
|---|---|---|---|---|
