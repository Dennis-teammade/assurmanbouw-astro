...
|---|------|---------|-------|-----------|--------|
| 1 | `grondwerkers` | ruwbouw | ruwbouw-cluster.md | `gw-` | TODO |
...
| 7 | `parketzetters` | afwerking | afwerking-cluster.md | `prk-` | TODO |
| 8 | `zonnepanelen-installateurs` | technieken | technieken-cluster.md | `zon-` | TODO |
