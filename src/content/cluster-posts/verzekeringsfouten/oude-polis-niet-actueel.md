---
slug: "oude-polis-niet-actueel"
tileTitle: "Oude polis niet meer actueel"
title: "Waarom je polis van 5 jaar geleden vandaag waarschijnlijk niet meer klopt"
spokeId: "P5-S8"
parentPillar: "verzekeringsfouten"
seoTitle: "Verouderde verzekeringspolis bouw: wat checken in 2026? | Assurman"
metaDescription: "Verouderde verzekeringspolis bouw: hoe wetgeving sinds 2018, indexatie en bedrijfsgroei je oude polis ondergraven. Checklist om je dekking up-to-date te krijgen."
primaryKeyword: "verouderde verzekeringspolis bouw"
secondaryKeywords:
  - "oude polis aannemer hervragen"
  - "polis review 5 jaar"
  - "verzekering bouwbedrijf updaten"
  - "indexatie kapitaal polis"
  - "polis aanpassen nieuwe activiteit"
...
faq:
  - q: "Hoe vaak moet ik mijn verzekeringspolis reviewen?"
    a: "Aanbevolen: jaarlijks een lichte check (kapitalen, indexatie, eventuele wijzigingen in de onderneming) en elke 3 tot 5 jaar een grondige review met een gespecialiseerde makelaar. Bij significante gebeurtenissen (nieuwe activiteit, eerste werknemer, BV-oprichting, schadegeval) is een tussentijdse review aan de orde, ongeacht de tijd sinds de laatste check."
  - q: "Wat is veranderd in de bouwverzekering tussen 2021 en 2026?"
    a: "Vier hoofdzaken: Boek 6 BW sinds 1 januari 2025 (einde quasi-immuniteit hulppersonen, verhoogd risico voor onderaannemers en werknemers), inflatie en ABEX-stijging van 20% tot 30% met impact op vaste kapitalen, strengere schijnzelfstandigheid-regels en hogere premietarieven in bepaalde segmenten. Daarnaast hebben verzekeraars hun polisstructuren aangepast aan deze ontwikkelingen."
  - q: "Wat is de minimumdekking BA Onderneming voor een aannemer in 2026?"
    a: "Onze adviesvloer is €2.500.000 per schadegeval, met uitschieters tot €5.000.000 voor risicovolle specialisten (dakwerkers, stabiliteitsstudies, technieken die waterdichtheid raken). Onder Boek 6 BW kunnen onderaannemers en werknemers rechtstreeks worden gedagvaard, waardoor het primaire risico op de eigen BA Onderneming valt. Pre-Boek 6 polissen met €500.000 à €1.000.000 zijn structureel te laag."
  - q: "Past mijn polis automatisch aan voor inflatie?"
    a: "Niet automatisch, tenzij er een indexatieclausule in de polisvoorwaarden staat. Drie types kapitaal: vast kapitaal (geen aanpassing), geïndexeerd kapitaal (volgens vast percentage of CPI), en ABEX-gekoppeld kapitaal (specifiek voor BA-10, jaarlijks geïndexeerd). Open je polis en zoek de term 'indexatie' of 'ABEX' om te zien wat van toepassing is."
  - q: "Wat als ik nieuwe activiteiten heb die niet in mijn polis staan?"
    a: "Dat is een dekkingsgat. Verzekeraars dekken doorgaans alleen activiteiten die expliciet in de polis vermeld zijn. Als je nieuwe activiteiten hebt (nieuwe stiel, nieuwe technieken, nieuwe werftypes), moeten die toegevoegd worden aan de polis of opgenomen worden in een aangepast pakket. Bij een schadegeval op een niet-vermelde activiteit kan de verzekeraar dekking weigeren."
  - q: "Kan ik halverwege een polisjaar wijzigen?"
    a: "Ja, bijvoegsels kunnen op elk moment worden aangevraagd voor wijzigingen in dekking, kapitalen of activiteiten. Verzekeraars passen de premie aan naar rato van de resterende periode. Bij grote wijzigingen (overstap naar andere verzekeraar, herstructurering polispakket) is de jaarlijkse vervaldag het logische moment, maar tussentijds is technisch mogelijk. De makelaar regelt de administratie."
conclusion: |-
...
| Jaar | Wijziging | Impact op polis |
|---|---|---|
| 2017 | Wet-Peeters-Borsus | BA-10-plicht voor woningbouw |
| 2019 | Uitbreiding Wet-Peeters-Borsus | Nieuwe bouwactoren onder plicht |
| 2024 | Hervorming wet schijnzelfstandigheid | Strengere criteria, hoger risico herkwalificatie |
| 2025 | Boek 6 BW | Quasi-immuniteit hulppersonen vervalt |
