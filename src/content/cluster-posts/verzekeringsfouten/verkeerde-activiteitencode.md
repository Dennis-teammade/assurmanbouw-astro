---
slug: "verkeerde-activiteitencode"
tileTitle: "Verkeerde activiteitencode"
title: "Verkeerde NACEBEL-code: hoe het je premie kunstmatig verhoogt"
spokeId: "P5-S4"
parentPillar: "verzekeringsfouten"
seoTitle: "Verkeerde NACEBEL-code verzekering: premie corrigeren 2026 | Assurman"
metaDescription: "Verkeerde NACEBEL-code verzekering: hoe activiteitencodes je premie kunstmatig verhogen, waarom ze fout staan en hoe je ze laat corrigeren bij verzekeraar."
primaryKeyword: "verkeerde NACEBEL-code verzekering"
secondaryKeywords:
  - "NACEBEL-code aannemer"
  - "activiteitencode verzekering bouw"
  - "premietarief verkeerde code"
  - "NACEBEL aanpassen verzekeraar"
  - "premie BA Onderneming corrigeren"
...
faq:
  - q: "Wat is een NACEBEL-code?"
    a: "Een NACEBEL-code is een numerieke code die de hoofd- en nevenactiviteiten van je onderneming beschrijft volgens de Belgische uitwerking van de Europese NACE Rev. 2-classificatie. In de bouwsector vallen de meeste activiteiten onder sectie F met codes startend op 41, 42 of 43. De code wordt geregistreerd in de Kruispuntbank Ondernemingen (KBO) en bepaalt mee het premietarief dat verzekeraars op je polissen toepassen."
  - q: "Hoe weet ik welke code op mijn polis staat?"
    a: "Check je polisvoorwaarden of het bijvoegsel dat je verzekeraar bij elke wijziging meestuurt. De code staat doorgaans bij de 'verzekerde activiteit' of 'bedrijfsomschrijving'. Als je twijfelt, vraag je makelaar of de underwriter een schriftelijke bevestiging van de gehanteerde code(s). Vergelijk die met je werkelijke hoofdactiviteit en de codes geregistreerd in de KBO."
  - q: "Hoe pas ik een verkeerde code aan?"
    a: "Aanpassing verloopt via twee sporen: ten eerste in de KBO via je ondernemingsloket (kostprijs ongeveer €85-€120), ten tweede op de polis via je verzekeraar of makelaar. De verzekeraar past niet automatisch aan op basis van KBO-updates, dus je moet expliciet om een herclassificatie vragen. De verzekeraar levert daarna een bijvoegsel met de nieuwe code en het aangepaste premietarief."
  - q: "Hoeveel kan ik besparen met de juiste code?"
    a: "In onze polisreviews zien we typische besparingen van €500 tot €2.500 per jaar bij middelgrote bouwbedrijven. Voor specifieke gevallen (gespecialiseerde activiteiten met laag risicoprofiel die nu onder 'algemene aannemerij' vallen) loopt de besparing op tot €3.000 of meer per jaar. De besparing blijft jaar na jaar lopen, want de premiestructuur volgt de polis voor de hele looptijd."
  - q: "Wat als ik meerdere activiteiten heb?"
    a: "Als je meerdere significante activiteiten hebt (elk meer dan ongeveer 5% van je omzet), worden die best allemaal in de polis opgenomen. Je hebt één hoofdcode voor de dominante activiteit, en eventueel nevencodes voor de bijkomstige activiteiten. De verzekeraar past dan een gewogen tarief toe of werkt met een gemengde polisformule. Een eerlijke verklaring is hier cruciaal: te eng = dekkingsweigering, te breed = teveel premie."
  - q: "Kan ik teveel betaalde premies uit het verleden terugvorderen?"
    a: "In de regel niet. Verzekeraars werken met prospectieve aanpassing: de gecorrigeerde code geldt vanaf de aanpassing, niet retroactief. Bij de jaarlijkse premievervaldag kun je een herevaluatie laten uitvoeren die voor de volgende periode in je voordeel werkt. Voor de toekomst loont het dus snel de moeite, voor het verleden niet."
conclusion: |-
