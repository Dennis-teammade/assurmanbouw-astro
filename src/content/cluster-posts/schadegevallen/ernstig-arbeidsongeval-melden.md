---
slug: "ernstig-arbeidsongeval-melden"
tileTitle: "Ernstig arbeidsongeval melden"
title: "Wat als je een ernstig arbeidsongeval moet melden?"
spokeId: "P3-S6"
parentPillar: "schadegevallen"
seoTitle: "Ernstig arbeidsongeval melden: stappen, termijnen en sancties 2026 | Assurman"
metaDescription: "Ernstig arbeidsongeval melden: hoe doe je het correct, welke termijnen gelden en wat is het omstandig verslag? Volledig stappenplan voor werkgevers."
primaryKeyword: "ernstig arbeidsongeval melden"
secondaryKeywords:
  - "arbeidsinspectie melding"
  - "omstandig verslag arbeidsongeval"
  - "fedris ernstig ongeval"
...
heroImage: "/images/kenniscentrum/c3-6-ernstig-arbeidsongeval-melden.jpg"
heroImageAlt: "Werkgever stelt omstandig verslag op aan bureau, met dossier en formulieren"
tldr: >-
...
relatedSpokes:
  ...
  - "polisweigering"
faq:
  - q: "Wat maakt een arbeidsongeval ernstig volgens de wet?"
    a: "De definitie staat in artikel I.6-2 van de Codex over het welzijn op het werk. Drie categorieën: aard van het letsel (overlijden, blijvende invaliditeit, specifieke verwondingen), aard van het ongeval (val boven 2 meter, contact elektrische stroom, instorting), aard van de werkpost (werken op hoogte, in besloten ruimten). Als één van deze categorieën van toepassing is, is het ongeval ernstig."
  - q: "Aan wie moet ik een ernstig arbeidsongeval onmiddellijk melden?"
    a: "Aan de Toezicht op het Welzijn op het Werk (FOD Werkgelegenheid). Dat is een aparte verplichting bovenop de aangifte aan de arbeidsongevallenverzekeraar (8 dagen). Beide meldingsplichten bestaan parallel en je moet ze beide vervullen. Contactgegevens per regio vind je op werk.belgie.be."
  - q: "Wat is een omstandig verslag?"
    a: "Een omstandig verslag is een formeel document dat je binnen 10 werkdagen na een ernstig arbeidsongeval moet opstellen. Het bevat: identificatie, beschrijving van de feiten, oorzakenanalyse (directe, onderliggende en roodzakke oorzaak), genomen maatregelen, en preventiemaatregelen. Het wordt typisch opgesteld door je interne preventieadviseur of externe preventiedienst."
  - q: "Wat zijn de sancties bij niet-melding?"
    a: "Administratieve boetes tot €4.000 per inbreuk, mogelijk meer bij meerdere overtredingen. Bij ernstige tekortkomingen kan de inspectie het dossier doorgeven aan het arbeidsauditoraat, met strafrechtelijke geldboetes tot €60.000 per inbreuk (vermenigvuldigd met de opdeciemen) en in uitzonderlijke gevallen gevangenisstraf."
  - q: "Wat als ik twijfel of het ongeval ernstig is?"
    a: "Behandel het als ernstig en meld het. Onnodig melden is niet sanctioneerbaar, niet-melden wel. Een telefoontje naar de inspectie of je preventiedienst kan in twijfelgevallen helpen om snel duidelijkheid te krijgen voordat je een definitieve aangifte doet."
  - q: "Komt de arbeidsinspectie altijd ter plaatse bij een ernstig ongeval?"
    a: "In de meeste gevallen wel, vaak nog dezelfde dag of de dag na het ongeval. Bij zeer ernstige ongevallen (overlijden, ernstig blijvend letsel) komen ze quasi altijd. Bij minder ernstige gevallen die toch onder de definitie vallen (bv. een val van 2,5 meter zonder zware blessures) kan het beperkt blijven tot een telefonisch onderzoek."
  - q: "Verhoogt mijn premie na een ernstig arbeidsongeval?"
    a: "Mogelijk. De premievoet van de arbeidsongevallenverzekering wordt elk jaar bijgesteld op basis van het schadeverleden. Een ernstig ongeval kan leiden tot een premie-verhoging in volgende jaren, vooral als de uitkering hoog is (bv. blijvende invaliditeit, langdurige arbeidsongeschiktheid). Bespreek met je makelaar wat de impact kan zijn."
conclusion: |-
...
- Telefonisch via het regionale contactnummer van Toezicht op het Welzijn op het Werk (zie [werk.belgie.be](https://werk.belgie.be) voor de juiste contactgegevens per regio)
